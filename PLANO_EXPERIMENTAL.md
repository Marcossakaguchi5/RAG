...
O núcleo executável dessa etapa fica em `experiments/groundtruth/`.
...
`experiments/runs/antigos/sciq/20260707-183922/manifest.json`.

Essa rodada, arquivada em `experiments/runs/antigos/sciq/20260707-183922`, ainda não
