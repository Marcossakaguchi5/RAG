...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=root / "figures" / "slides_pdf_ir")
    parser.add_argument(
        "--ato-de-ler-run",
        type=Path,
        default=root / "experiments" / "runs" / "novas" / "pdf-ir" / "pdf-principal-02",
    )
    parser.add_argument(
        "--livro-ri-run",
        type=Path,
        default=root / "experiments" / "runs" / "novas" / "pdf-ir" / "iir-principal-03",
    )
    parser.add_argument(
        "--sciq-run",
        type=Path,
        default=root / "experiments" / "runs" / "novas" / "sciq" / "sciq-atualizada-01",
    )
