...
```bash
python3 experiments/groundtruth/materialize.py validate \
  --cases experiments/groundtruth/cases.example.jsonl \
...
```bash
python3 -m unittest discover -s experiments/groundtruth -p 'test_*.py' -v
```
